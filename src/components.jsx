...
export function onAppear(el, cb, ratio = 0.88) {
  let done = false;
  const check = () => {
...
/* ---------- Count-up number ---------- */
export function CountUp({ to, suffix = "", decimals = 0 }) {
  const ref = useRef(null);
...
/* ---------- Eyebrow ---------- */
export function Eyebrow({ children, onAccent }) {
...
/* ============================================================
   HEADER
   ============================================================ */
export function Header({ t, locale, setLocale, theme, toggleTheme, route, go }) {
