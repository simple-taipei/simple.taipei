...
import { Icon, Reveal, Eyebrow } from './components'

export function HomePage({ t, motif, go }) {
  const h = t.home;
          ...
          <div className="svc-list">
            ...
            <Reveal key={i} delay={i * 70} className="svc-row">
                ...
                <a href={s.link} target="_blank" rel="noopener noreferrer" className="svc-row-cta">
                  {h.learnMore}<span className="sr-only"> – {s.title}</span><Icon name="arrowUpRight" />
                </a>
              </Reveal>
            )}
          </div>
          ...
          <div className="loc-grid">
            ...
            <Reveal key={l.code} delay={i * 90} as="button" className="loc-card card" style={{ textAlign: "left", cursor: "pointer", font: "inherit", color: "inherit" }}>
                <div className="loc-inner" onClick={() => setActiveLoc(l)}>
                  <div className="loc-img" style={{ backgroundImage: `url(${l.code === "TPE" ? "/locations/taipei.webp" : l.code === "SIN" ? "/locations/singapore.webp" : "/locations/hongkong.webp"})` }}>
...
export function CTABand({ title, sub, btn, href }) {
  return (
...
export function LocationModal({ loc, t, onClose }) {
  useEffect(() => {
    if (!loc) return;
  ...
  return (
    <div className="modal-scrim" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
        ...
        <div className="modal-hero" style={{ backgroundImage: `url(${img === "taipei" ? "/locations/taipei.webp" : img === "singapore" ? "/locations/singapore.webp" : "/locations/hongkong.webp"})` }}>
