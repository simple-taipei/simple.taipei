/* ============================================================
   PARTNERSHIP & RESPONSIBILITY PAGES
   ============================================================ */
import { useState, useEffect } from 'react'
import { Icon, Reveal, Eyebrow, CountUp } from './components'
import { CTABand } from './home'

export function Rotator({ items }) {
...
export function PageHero({ eyebrow, prefix, rotating, title, subtitle, cta, ctaHref, onCtaClick, motif }) {
  return (
...
export function PartnershipPage({ t, motif, go }) {
...
export function ResponsibilityPage({ t, motif, go }) {
  const r = t.responsibility;
